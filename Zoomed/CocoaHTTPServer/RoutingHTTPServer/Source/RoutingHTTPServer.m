...
//        NSString *tt = NSTemporaryDirectory();
//        NSString *unixSocketPath = [NSString stringWithFormat:@"%@%@",tt,@"unix.server.socket"];
//        NSURL *unixSocketURL = [NSURL fileURLWithPath:unixSocketPath];
//        success = [asyncSocket acceptOnUrl:unixSocketURL error:&err];
//        if (success)
//        {
